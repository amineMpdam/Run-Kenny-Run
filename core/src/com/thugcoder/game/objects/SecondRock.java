...
/**
 * Created by Landolsi on 04/11/2015.
 */
public class SecondRock extends AbstractGameObject {
    ...
    private void init() {
        ...
        regEdge = Assets.instance.anOtherRock.edge;
        regMiddle = Assets.instance.anOtherRock.middle;
