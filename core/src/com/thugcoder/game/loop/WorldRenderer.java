...
public class WorldRenderer implements Disposable {
    ...
    private void init() {
        ...
        camera = new OrthographicCamera(com.thugcoder.game.utils.Constants.VIEWPORT_WIDTH,
                com.thugcoder.game.utils.Constants.VIEWPORT_HEIGHT);
        camera.position.set(0, 0, 0);
        camera.update();

        cameraGUI = new OrthographicCamera(com.thugcoder.game.utils.Constants.VIEWPORT_GUI_WIDTH,
    ...
    public void resize(int width, int height) {
        camera.viewportWidth = (com.thugcoder.game.utils.Constants.VIEWPORT_HEIGHT / height) *
                width;
        camera.update();
        cameraGUI.viewportHeight = com.thugcoder.game.utils.Constants.VIEWPORT_GUI_HEIGHT;
        cameraGUI.viewportWidth = (com.thugcoder.game.utils.Constants.VIEWPORT_GUI_HEIGHT
    ...
    private void renderGuiScore(SpriteBatch batch) {
        ...
        batch.draw(Assets.instance.goodCheese.goodCheese, x, y, offsetX,
    ...
    private void renderGuiExtraLive(SpriteBatch batch) {
        float x = cameraGUI.viewportWidth - 50 -
                com.thugcoder.game.utils.Constants.LIVES_START * 50;
        float y = -15;
        for (int i = 0; i < com.thugcoder.game.utils.Constants.LIVES_START; i++) {
            if (worldController.lives <= i)
                batch.setColor(0.5f, 0.5f, 0.5f, 0.5f);
            batch.draw(Assets.instance.kenny.head,
    ...
    private void renderGuiFeatherPowerup(SpriteBatch batch) {
        ...
        float timeLeftFeatherPowerup =
                worldController.level.kennyHead.timeLeftFeatherPowerup;
        if (timeLeftFeatherPowerup > 0) {
            ...
            batch.draw(Assets.instance.badCheese.badCheese,
    ...
    private void renderGui(SpriteBatch batch) {
        ...
        // draw collected green cheese icon (anchored to top left edge)
